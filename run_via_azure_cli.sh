...
SIZES=("Standard_D8als_v6")
SIZES=("${SIZES[@]}" "Standard_D4s_v3" "Standard_FX4mds") 
SIZES=("${SIZES[@]}" "Standard_D4ds_v5" "Standard_D4ds_v4")
SIZES=("${SIZES[@]}" "Standard_D8ds_v5" "Standard_D8ds_v4")
SIZES=("${SIZES[@]}" "Standard_FX48mds" "Standard_D4plds_v6")
SIZES=("${SIZES[@]}" "Standard_D2as_v6" "Standard_F4als_v6")
SIZES=("${SIZES[@]}" "Standard_E4as_v5" "Standard_D8as_v5")
SIZES=("${SIZES[@]}" "Standard_E64bs_v5" "Standard_B4als_v2")
VM_PREFIX="perf-test"
